# Vintner 1.4.0 grape bowl and wine basket acceptance

Automated validation does not complete these visual and hands-on checks. Use a
disposable 1.4.0 QA world with the final candidate JAR and record screenshots or
notes beside each item before publication.
...
- [ ] A partially eaten bowl preserves its cultivar and remaining appearance after break and re-placement.
...
- [ ] An aged bottle keeps the canonical aged finish.
- [ ] Directly targeting an occupied basket shows the canonical nearby wine name; an empty basket shows none.
- [ ] Empty-hand retrieval returns the exact expected bottle and leaves the empty basket placed.

## Shared decorative behavior

- [ ] Fences, walls, panes and bars do not connect unexpectedly.
- [ ] Adjacent copies, collision outlines and lighting look appropriate for low-profile décor.
