...
2. Rename an Almanac in an anvil to the desired plot name, such as
   `Upper Slope` or `River Field`.
3. Sneak-use the Almanac on one corner of suitable vineyard land. The normal
   survey report records that corner.
...
- Sneak-use the Almanac in the air to see the estate's total named-plot count
  and registered area.
