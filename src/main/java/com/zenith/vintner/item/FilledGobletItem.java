...
public final class FilledGobletItem extends GobletItem {
    public FilledGobletItem(
            GobletMaterial material,
    ...
    public Component getName(ItemStack stack) {
        ...
        return Component.translatable(
                "item.vintner.filled_goblet.named",
    ...
    public static ItemStack fromBottle(
            ItemStack source,
            GobletMaterial material
    ) {
        ItemStack goblet = new ItemStack(
                ModItems.filledGoblet(material)
        );
        WineMetadata.copyBatchMetadata(source, goblet);

        String profileId = source.getItem() instanceof WineItem wine
                ? wine.effectProfile().id()
                : WineMetadata.effectProfile(source);
        WineMetadata.setEffectProfile(goblet, profileId);
        WineMetadata.setServings(goblet, 1);
        return goblet;
    }
